...
var (
	...
	bucketeerEnableDebugLog = flag.Bool("bucketeer-enable-debug-log", false, "Outputs sdk debug logs or not")
	...
	goalID                  = flag.String("goal-id", "", "Target goal ID for tracking")
...
func main() {
	...
	options := []bucketeer.Option{
		...
		bucketeer.WithHost(*bucketeerAPIEndpoint),
