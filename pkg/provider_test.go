...
import (
	...
	"github.com/bucketeer-io/openfeature-go-server-sdk/pkg/mocks"
)
...
func TestBooleanEvaluation(t *testing.T) {
	...
	tests := []struct {
		...
		setupMock               func(mockSDK *mocks.MockBucketeerSDK, flagKey string, defaultValue bool)
	}{
		{
	...
	for _, test := range tests {
		t.Run(test.desc, func(t *testing.T) {
			...
			mockSDK := mocks.NewMockBucketeerSDK(ctrl)
...
func TestStringEvaluation(t *testing.T) {
	...
	tests := []struct {
		...
		expectedResolutionError openfeature.ResolutionError
		failToBucketeerUser     bool
		setupMock               func(mockSDK *mocks.MockBucketeerSDK, flagKey string, defaultValue string)
	}{
		{
...
func TestIntEvaluation(t *testing.T) {
	...
	tests := []struct {
		...
		expectedResolutionError openfeature.ResolutionError
		failToBucketeerUser     bool
		setupMock               func(mockSDK *mocks.MockBucketeerSDK, flagKey string, defaultValue int64)
	}{
		{
...
func TestFloatEvaluation(t *testing.T) {
	...
	tests := []struct {
		...
		expectedResolutionError openfeature.ResolutionError
		failToBucketeerUser     bool
		setupMock               func(mockSDK *mocks.MockBucketeerSDK, flagKey string, defaultValue float64)
	}{
		{
...
func TestObjectEvaluation(t *testing.T) {
	...
	tests := []struct {
		...
		expectedResolutionError openfeature.ResolutionError
		failToBucketeerUser     bool
		setupMock               func(mockSDK *mocks.MockBucketeerSDK, flagKey string, defaultValue interface{})
	}{
		{
